...
describe("GET /", function () {
  ...
  test("It should respond with array of invoices", async function () {
    ...
    expect(response.body).toEqual({
      "invoices": [
        {id: 1, comp_code: "apple", add_date: '2018-01-01T08:00:00.000Z', amt: 100, paid: false, paid_date: null},
        {id: 2, comp_code: "apple", add_date: '2018-02-01T08:00:00.000Z', amt: 200, paid: true, paid_date: '2018-02-02T08:00:00.000Z'},
        {id: 3, comp_code: "ibm", add_date: '2018-03-01T08:00:00.000Z', amt: 300, paid: false, paid_date: null},
      ]
    });
  })
...
describe("DELETE /", function () {
  ...
  test("It should delete invoice", async function () {
    ...
    expect(response.body).toEqual({"msg": "Invoice deleted"});
  });
